        ...
        <section className="home-hero">
          ...
          <header data-thq="thq-navbar" className="home-navbar">
            ...
            >
              <nav
                  ...
                  className="home-nav"
              >
                <span className="home-link navLink">Home</span>
                <span className="home-link1 navLink">About</span>
                <span className="home-link2 navLink">Why</span>
                <span className="home-link3 navLink">Contact</span>
              </nav>
          ...
          <div className="home-hero-content">
            ...
            <span>
              ...
              <br></br>
              <span>the smart way to manage & allocate your equipment</span>
            </h1>
            <div className="home-caption">
              <button className="home-register2 button-style-1 button">
                <span className="home-text11">Register now</span>
              </button>
              <p className="home-caption1">
                22—24 November 2023 / whitoutwire.inventory.platform
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="home-content2">
            <div className="home-details3">
              ...
              <p className="home-description3">
                SMART-EMS is the ultimate solution for efficiently and effectively managing your organization's equipment and allocating
