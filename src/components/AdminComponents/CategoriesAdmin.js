...
const CategoriesAdmin = (props) => {
        ...
        return(
            <>
                <button onClick={() => handleUpdate(category)}>
                    <svg width="24" height="23" viewBox="0 0 24 23" fill="none" xmlns="http://www.w3.org/2000/svg" className="action-button">
                ...
                <button onClick={() => handleDelete(category.id)} className="action-button">
    ...
    const handleUpdate = (category) => {
        ...
        axios
            .put(`http://127.0.0.1:8000/categories/${category.id}/`, category)
            .then((response) => {
