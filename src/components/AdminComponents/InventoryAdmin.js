                ...
                <div className="overview-grids">
                    <div className="overview-item">
                        <svg width="31" height="30" viewBox="0 0 31 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M13.0381 7.06943H12.9381V7.16943V7.76504V7.86504H13.0381H17.8034H17.9034V7.76504V7.16943V7.06943H17.8034H13.0381Z" fill="#DBA362" stroke="#DBA362" stroke-width="0.2"/>
                        </svg>
                    ...
                    <div className="overview-item">
                        ...
                        <p>{equipmentData.filter(e => e.condition === "new").length}</p>
                        <p>Good Condition</p>
                    </div>
                    <div className="overview-item">
