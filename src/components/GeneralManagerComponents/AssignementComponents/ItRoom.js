...
const ItRoom = (props) => {
    ...
    for (let i = 0; i < itRoomNames.length; i++) {
        overviewItems.push({title: itRoomNames[i], count: 0});
    }
        ...
        <>
            ...
            />
                <div className="inventory-table">
                    ...
                    {itRoomNames.length === 0 ? <div style={{padding:'20px'}}>No locations avaliable in this type</div> : <div className="overview-grid" style={{padding:'20px'}}>
